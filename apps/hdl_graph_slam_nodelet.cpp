...
public:
  ...
  HdlGraphSlamNodelet() {
    ...
    //lio and points
    odom_sub.reset(new message_filters::Subscriber<nav_msgs::Odometry>(nh, "/lio", 256));
    ...
    //constraint RTK******
    if(nh.param<bool>("enable_gps", false)) {
      ...
      navsat_sub = nh.subscribe("/gps/fix", 1024, &HdlGraphSlamNodelet::navsat_callback, this);
    }
